...
const english = {
  text: {
    ...
    "index-my-portfolio": "My portfolio",
    ...
    "about-me-skillset-text-2-3": "Databases: Relational (SQL) and non-relational (MongoDB).",
    "about-me-skillset-subtitle-3": "Other:",
    ...
    // "contact-form-email-placeholder": "john@doe.com",
    "contact-form-howcani": "How can I help you?",
    // "contact-form-howcani-placeholder": "I need you to build me an amazing website!",
    "contact-form-submitbutton": "Let's talk",
    "contact-confirmation-button": "Send another message",

    "footer-info-1-1": "Ciudad del Río",
    "footer-info-1-2": "Medellín, Colombia",
    "footer-info-1-3": "NIT: 1000861035",

    "footer-info-2-1": "Privacy Policy",
    "footer-info-2-2": "Terms & conditions"
  },
  placeholders: {
    "contact-form-name-placeholder": "John Doe",
    "contact-form-email-placeholder": "john@doe.com",
